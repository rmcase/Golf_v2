 ...
 */
public class nineHoleTab extends Activity {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null) {
                    ...
                    for (int i = 0; i < objects.size(); i++) {
                        scoreLC.setText(objects.get(i).getNumber("Scoref9").toString());
                        puttLC.setText(objects.get(i).getNumber("Puttsf9").toString());
                        fwLC.setText(objects.get(i).getNumber("Fairwaysf9").toString());
                        girLC.setText(objects.get(i).getNumber("GIRsf9").toString());
                        birdiesLC.setText(objects.get(i).getNumber("Birdiesf9").toString());
                        parLC.setText(objects.get(i).getNumber("Parf9").toString());
                        parsLC.setText(objects.get(i).getNumber("Parsf9").toString());
                        bogeyLC.setText(objects.get(i).getNumber("Bogeysf9").toString());
                        eagleLC.setText(objects.get(i).getNumber("Eaglesf9").toString());
                        otherLC.setText(objects.get(i).getNumber("Otherf9").toString());
                        udLC.setText(objects.get(i).getNumber("UpDownf9").toString());
